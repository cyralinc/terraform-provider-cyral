...
func repositoryDataSourceTestRepos() []internal.RepoInfo {
	return []internal.RepoInfo{
		{
...
func testRepositoryDataSource(repoDatas []internal.RepoInfo, nameFilter, typeFilter string) (
...
func testRepositoryDataSourceConfig(repoDatas []internal.RepoInfo, nameFilter, typeFilter string) string {
	var config string
...
func testRepositoryDataSourceChecks(repoDatas []internal.RepoInfo, nameFilter, typeFilter string) resource.TestCheckFunc {
...
func filterRepoDatas(repoDatas []internal.RepoInfo, nameFilter, typeFilter string) []internal.RepoInfo {
	var filteredRepoDatas []internal.RepoInfo
	for _, repoData := range repoDatas {
