...
var initialAccessRulesConfig *accessrules.AccessRulesResource = &accessrules.AccessRulesResource{
	AccessRules: []*accessrules.AccessRule{
		{
			Identity: &accessrules.AccessRulesIdentity{
				Name: "identityEmail",
				Type: "email",
			},
			ValidFrom:  &validFrom,
			ValidUntil: &validUntil,
			Config: &accessrules.AccessRulesConfig{
...
var updatedAccessRulesConfig *accessrules.AccessRulesResource = &accessrules.AccessRulesResource{
	AccessRules: []*accessrules.AccessRule{
		{
			Identity: &accessrules.AccessRulesIdentity{
...
var barebonesAccessRulesConfig *accessrules.AccessRulesResource = &accessrules.AccessRulesResource{
	AccessRules: []*accessrules.AccessRule{
		{
			Identity: &accessrules.AccessRulesIdentity{
...
func setupRepositoryAccessRulesTest(
	accessRulesData *accessrules.AccessRulesResource,
	bareBones bool,
...
func accessRulesToConfig(
	res *accessrules.AccessRulesResource,
	repoID string,
