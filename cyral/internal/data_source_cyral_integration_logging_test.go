...
func testIntegrationLoggingDataSourceConfigDependencies(resName string) string {
	...
	resource1, _ := formatLogsIntegrationDataIntoConfig(internal.LoggingIntegration{
		Name:             resName1,
	...
	resource2, _ := formatLogsIntegrationDataIntoConfig(internal.LoggingIntegration{
		Name:             resName2,
		ReceiveAuditLogs: true,
		LoggingIntegrationConfig: internal.LoggingIntegrationConfig{
