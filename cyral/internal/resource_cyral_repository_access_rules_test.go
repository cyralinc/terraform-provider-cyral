...
var initialAccessRulesConfig *internal.AccessRulesResource = &internal.AccessRulesResource{
	AccessRules: []*internal.AccessRule{
		{
			Identity: &internal.AccessRulesIdentity{
				Name: "identityEmail",
				Type: "email",
			},
			ValidFrom:  &validFrom,
			ValidUntil: &validUntil,
			Config: &internal.AccessRulesConfig{
...
var updatedAccessRulesConfig *internal.AccessRulesResource = &internal.AccessRulesResource{
	AccessRules: []*internal.AccessRule{
		{
			Identity: &internal.AccessRulesIdentity{
...
var barebonesAccessRulesConfig *internal.AccessRulesResource = &internal.AccessRulesResource{
	AccessRules: []*internal.AccessRule{
		{
			Identity: &internal.AccessRulesIdentity{
...
func setupRepositoryAccessRulesTest(
	accessRulesData *internal.AccessRulesResource,
	bareBones bool,
...
func accessRulesToConfig(
	res *internal.AccessRulesResource,
	repoID string,
