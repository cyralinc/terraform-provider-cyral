...
func initialPagerDutyIntegrationConfig() *internal.IntegrationConfExtension {
	integration := internal.NewIntegrationConfExtension(internal.PagerDutyTemplateType)
	integration.Name = utils.AccTestName(integrationPagerDutyResourceName, "pager-duty")
	integration.Parameters = "unitTest-parameters"
	return integration
}

func updatedPagerDutyIntegrationConfig() *internal.IntegrationConfExtension {
	integration := internal.NewIntegrationConfExtension(internal.PagerDutyTemplateType)
...
func setupPagerDutyIntegrationTest(integrationData *internal.IntegrationConfExtension) (string, resource.TestCheckFunc) {
