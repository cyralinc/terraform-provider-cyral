...
func genericSAMLDraftConfigInitial() *idpsaml.GenericSAMLDraft {
...
func genericSAMLDraftConfigUpdated() *idpsaml.GenericSAMLDraft {
	return &idpsaml.GenericSAMLDraft{
		DisplayName: utils.AccTestName(
...
func genericSAMLDraftConfigNoAttributes() *idpsaml.GenericSAMLDraft {
	return &idpsaml.GenericSAMLDraft{
		DisplayName: utils.AccTestName(
			integrationIdPSAMLDraftResourceName, "integration-2"),
		DisableIdPInitiatedLogin: true,
...
func setupIntegrationIdPSAMLDraftTest(t *testing.T, draft *idpsaml.GenericSAMLDraft, resName string) (
	string,
...
func formatGenericSAMLDraftIntoConfig(draft *idpsaml.GenericSAMLDraft, resName string) string {
