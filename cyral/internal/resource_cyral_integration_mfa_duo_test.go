...
func initialDuoMFAIntegrationConfig() *internal.IntegrationConfExtension {
	integration := internal.NewIntegrationConfExtension(internal.DuoMFATemplateType)
...
func updatedDuoMFAIntegrationConfig() *internal.IntegrationConfExtension {
	integration := internal.NewIntegrationConfExtension(internal.DuoMFATemplateType)
...
func setupDuoMFAIntegrationTest(
	t *testing.T,
	integrationData *internal.IntegrationConfExtension,
	resourceName string,
) (string, resource.TestCheckFunc) {

	var parameters internal.IntegrationConfExtensionParameters
