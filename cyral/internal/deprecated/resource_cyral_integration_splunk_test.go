...
var initialSplunkConfig deprecated.SplunkIntegration = deprecated.SplunkIntegration{
...
var updatedSplunkConfig deprecated.SplunkIntegration = deprecated.SplunkIntegration{
...
func setupSplunkTest(integrationData deprecated.SplunkIntegration) (string, resource.TestCheckFunc) {
...
func formatSplunkIntegrationDataIntoConfig(data deprecated.SplunkIntegration) string {
	return fmt.Sprintf(`
