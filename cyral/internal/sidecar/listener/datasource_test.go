...
func listenerDataSourceTestRepos() []listener.SidecarListener {
	return []listener.SidecarListener{
		{
			RepoTypes: []string{"mysql"},
			NetworkAddress: &listener.NetworkAddress{
				Port: 3306,
			},
		},
		{
...
func testListenerDataSource(listeners []listener.SidecarListener, repoTypeFilter string, portFilter int) (
...
func testListenerDataSourceConfig(listeners []listener.SidecarListener, repoTypeFilter string, portFilter int) string {
	var config string
...
func testListenerDataSourceChecks(listeners []listener.SidecarListener, repoTypeFilter string, portFilter int) resource.TestCheckFunc {
...
func filterListenerData(listeners []listener.SidecarListener, repoTypeFilter string, portFilter int) []listener.SidecarListener {
	var filteredListeners []listener.SidecarListener
