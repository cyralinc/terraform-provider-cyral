...
var initialSumoLogicConfig internal.SumoLogicIntegration = internal.SumoLogicIntegration{
	Name:    utils.AccTestName(integrationSumoLogicResourceName, "sumo-logic"),
	Address: "https://sumologic.local/initial",
}

var updatedSumoLogicConfig internal.SumoLogicIntegration = internal.SumoLogicIntegration{
...
func setupSumoLogicTest(integrationData internal.SumoLogicIntegration) (string, resource.TestCheckFunc) {
...
func formatSumoLogicIntegrationDataIntoConfig(data internal.SumoLogicIntegration) string {
	return fmt.Sprintf(`
