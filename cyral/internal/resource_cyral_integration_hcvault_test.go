...
var initialHCVaultIntegrationConfig internal.HCVaultIntegration = internal.HCVaultIntegration{
...
var updatedHCVaultIntegrationConfig internal.HCVaultIntegration = internal.HCVaultIntegration{
...
func setupHCVaultIntegrationTest(integrationData internal.HCVaultIntegration) (string, resource.TestCheckFunc) {
...
func formatHCVaultIntegrationDataIntoConfig(data internal.HCVaultIntegration) string {
	return fmt.Sprintf(`
