...
func integrationIdPSAMLDataSourceTestIdps() []internal.GenericSAMLIntegration {
	return []internal.GenericSAMLIntegration{
		{
			ID: "id-1",
			...
			IdpType:  "idp-type-1",
			Disabled: false,
			IdpDescriptor: &internal.GenericSAMLIdpDescriptor{
			...
			SPMetadata: &internal.GenericSAMLSPMetadata{
				XMLDocument: "xml-document-1",
			},
			Attributes: internal.NewRequiredUserAttributes(
				"first-name-1",
				"last-name-1",
				"email-1",
				"groups-1",
...
func testIntegrationIdPSAMLDataSourceChecks(t *testing.T, resName, nameFilter, typeFilter string) resource.TestCheckFunc {
	...
	testFunctions := []resource.TestCheckFunc{
		...
		resource.TestCheckResourceAttr(dataSourceFullName,
			"idp_list.0.attributes.0.first_name", internal.DefaultUserAttributeFirstName,
		),
		resource.TestCheckResourceAttr(dataSourceFullName,
			"idp_list.0.attributes.0.last_name", internal.DefaultUserAttributeLastName,
		),
		resource.TestCheckResourceAttr(dataSourceFullName,
			"idp_list.0.attributes.0.email", internal.DefaultUserAttributeEmail,
		),
		resource.TestCheckResourceAttr(dataSourceFullName,
			"idp_list.0.attributes.0.groups", internal.DefaultUserAttributeGroups,
		),
	}
...
func filterSAMLIdps(idps []internal.GenericSAMLIntegration, nameFilter, typeFilter string) []internal.GenericSAMLIntegration {
	var filteredIdps []internal.GenericSAMLIntegration
