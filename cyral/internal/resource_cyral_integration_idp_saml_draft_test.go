...
func genericSAMLDraftConfigInitial() *internal.GenericSAMLDraft {
	return &internal.GenericSAMLDraft{
...
func genericSAMLDraftConfigUpdated() *internal.GenericSAMLDraft {
	return &internal.GenericSAMLDraft{
		DisplayName: utils.AccTestName(
...
func genericSAMLDraftConfigNoAttributes() *internal.GenericSAMLDraft {
	return &internal.GenericSAMLDraft{
		DisplayName: utils.AccTestName(
			integrationIdPSAMLDraftResourceName, "integration-2"),
		DisableIdPInitiatedLogin: true,
...
func setupIntegrationIdPSAMLDraftTest(t *testing.T, draft *internal.GenericSAMLDraft, resName string) (
	string,
...
func formatGenericSAMLDraftIntoConfig(draft *internal.GenericSAMLDraft, resName string) string {
