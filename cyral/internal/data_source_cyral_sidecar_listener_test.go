...
func listenerDataSourceTestRepos() []internal.SidecarListener {
	return []internal.SidecarListener{
		{
...
func testListenerDataSource(listeners []internal.SidecarListener, repoTypeFilter string, portFilter int) (
...
func testListenerDataSourceConfig(listeners []internal.SidecarListener, repoTypeFilter string, portFilter int) string {
	var config string
...
func testListenerDataSourceChecks(listeners []internal.SidecarListener, repoTypeFilter string, portFilter int) resource.TestCheckFunc {
...
func filterListenerData(listeners []internal.SidecarListener, repoTypeFilter string, portFilter int) []internal.SidecarListener {
	var filteredListeners []internal.SidecarListener
