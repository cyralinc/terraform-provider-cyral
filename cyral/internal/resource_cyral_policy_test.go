...
var initialPolicyConfig = internal.Policy{
	Meta: &internal.PolicyMetadata{
...
var updatedPolicyConfig = internal.Policy{
	Meta: &internal.PolicyMetadata{
...
func setupPolicyTest(integrationData internal.Policy) (string, resource.TestCheckFunc) {
...
func formatPolicyTestConfigIntoConfig(data internal.Policy) string {
	return fmt.Sprintf(`
