...
var initialLogsConfigCloudWatch internal.LoggingIntegration = internal.LoggingIntegration{
	Name:             utils.AccTestName(integrationLogsResourceName, "LogsCloudWatchTest"),
	ReceiveAuditLogs: true,
	LoggingIntegrationConfig: internal.LoggingIntegrationConfig{
		CloudWatch: &internal.CloudWatchConfig{
			Region: "us-east-2",
			Group:  "group2",
			Stream: "abcd",
		},
...
var initialLogsConfigDataDog internal.LoggingIntegration = internal.LoggingIntegration{
	Name:             utils.AccTestName(integrationLogsResourceName, "Datadog"),
	ReceiveAuditLogs: true,
	LoggingIntegrationConfig: internal.LoggingIntegrationConfig{
		Datadog: &internal.DataDogConfig{
			ApiKey: "TESTING_API",
		},
	},
}
var initialLogsConfigElk internal.LoggingIntegration = internal.LoggingIntegration{
	Name:             utils.AccTestName(integrationLogsResourceName, "LogsElkComplete"),
	ReceiveAuditLogs: true,
	LoggingIntegrationConfig: internal.LoggingIntegrationConfig{
		Elk: &internal.ElkConfig{
			EsURL:     "http://es.com",
			KibanaURL: "http://kibana.com",
			EsCredentials: &internal.EsCredentials{
				Username: "gabriel",
				Password: "123",
			},
		},
...
var initialLogsConfigElkEmptyEsCredentials internal.LoggingIntegration = internal.LoggingIntegration{
...
var initialLogsConfigSplunk internal.LoggingIntegration = internal.LoggingIntegration{
	Name:             utils.AccTestName(integrationLogsResourceName, "Splunk"),
	ReceiveAuditLogs: true,
	LoggingIntegrationConfig: internal.LoggingIntegrationConfig{
		Splunk: &internal.SplunkConfig{
...
var initialLogsConfigSumologic internal.LoggingIntegration = internal.LoggingIntegration{
	Name:             utils.AccTestName(integrationLogsResourceName, "Sumologic"),
	ReceiveAuditLogs: true,
	LoggingIntegrationConfig: internal.LoggingIntegrationConfig{
		SumoLogic: &internal.SumoLogicConfig{
			Address: "https://www.hostname.com.br/path",
		},
	},
}

var initialLogsConfigFluentbit internal.LoggingIntegration = internal.LoggingIntegration{
	Name:             utils.AccTestName(integrationLogsResourceName, "Fluentbit"),
	ReceiveAuditLogs: true,
	LoggingIntegrationConfig: internal.LoggingIntegrationConfig{
		FluentBit: &internal.FluentBitConfig{
			Config: `[OUTPUT]
Name         stdout
Match        *`,
		},
...
var updatedLogsConfigCloudWatch internal.LoggingIntegration = internal.LoggingIntegration{
	Name:             utils.AccTestName(integrationLogsResourceName, "LogsCloudWatchTest"),
	ReceiveAuditLogs: true,
	LoggingIntegrationConfig: internal.LoggingIntegrationConfig{
		CloudWatch: &internal.CloudWatchConfig{
...
var updatedLogsConfigDataDog internal.LoggingIntegration = internal.LoggingIntegration{
	Name:             utils.AccTestName(integrationLogsResourceName, "Datadog"),
	ReceiveAuditLogs: true,
	LoggingIntegrationConfig: internal.LoggingIntegrationConfig{
		Datadog: &internal.DataDogConfig{
...
var updatedLogsConfigElk internal.LoggingIntegration = internal.LoggingIntegration{
	Name:             utils.AccTestName(integrationLogsResourceName, "LogsElkComplete"),
	ReceiveAuditLogs: true,
	LoggingIntegrationConfig: internal.LoggingIntegrationConfig{
		Elk: &internal.ElkConfig{
...
var updatedLogsConfigElkEmptyEsCredentials internal.LoggingIntegration = internal.LoggingIntegration{
	Name:             utils.AccTestName(integrationLogsResourceName, "LogsElkEmptyEsCredentials"),
	ReceiveAuditLogs: true,
	LoggingIntegrationConfig: internal.LoggingIntegrationConfig{
		Elk: &internal.ElkConfig{
...
var updatedLogsConfigSplunk internal.LoggingIntegration = internal.LoggingIntegration{
	Name:             utils.AccTestName(integrationLogsResourceName, "Splunk"),
	ReceiveAuditLogs: true,
	LoggingIntegrationConfig: internal.LoggingIntegrationConfig{
		Splunk: &internal.SplunkConfig{
...
var updatedLogsConfigSumologic internal.LoggingIntegration = internal.LoggingIntegration{
	Name:             utils.AccTestName(integrationLogsResourceName, "Sumologic"),
	ReceiveAuditLogs: true,
	LoggingIntegrationConfig: internal.LoggingIntegrationConfig{
		SumoLogic: &internal.SumoLogicConfig{
...
var updatedLogsConfigFluentbit internal.LoggingIntegration = internal.LoggingIntegration{
	Name:             utils.AccTestName(integrationLogsResourceName, "Fluentbit"),
...
func setupLogsTest(integrationData internal.LoggingIntegration) (string, resource.TestCheckFunc) {
...
func formatLogsIntegrationDataIntoConfig(data internal.LoggingIntegration, resName string) (string, error) {
	var config string
	switch {
