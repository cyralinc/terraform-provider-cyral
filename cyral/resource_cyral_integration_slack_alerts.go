...
func (data SlackAlertsIntegration) WriteToSchema(d *schema.ResourceData, c *client.Client) error {
	d.Set("name", data.Name)
	d.Set("url", data.URL)
	return nil
}

func (data *SlackAlertsIntegration) ReadFromSchema(d *schema.ResourceData, c *client.Client) error {
