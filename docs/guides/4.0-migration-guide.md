...
You can find the v3 example [here](https://github.com/cyralinc/terraform-provider-cyral/tree/main/examples/guides/3.x-config-example.tf)
and its equivalent in v4 [here](https://github.com/cyralinc/terraform-provider-cyral/tree/main/examples/guides/4.0-config-example.tf).
...
Find the instructions for [Migrating from 3.x to 4.0](#migrating-from-3.x-to-4.0) or [Migrating from 2.x to 4.0](#migrating-from-2.x-to-4.0)
...
Use this example if you configuring a repository different than MongoDB.
